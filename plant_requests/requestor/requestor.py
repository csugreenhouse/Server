...
while True:
    ...
    for camera_parameters in camera_parameter_list:
        ...
        try:
            ...
            response = hr.height_request(image, reference_tags, camera_parameters)
            graph_util.plot_height_request_response(image, f"plant_requests/requestor/{camera_id}_graph.jpg",response)
...
height_requests = hr.height_request(image, reference_tags, camera_parameters, )
"""
