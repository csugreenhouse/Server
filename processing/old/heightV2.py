...
def generate_query(file_path):
    ...
    print_graph_from_metrics(height_metrics,"processing/test/images/ output.png")
...
barcode_metrics = get_barcode_metrics("processing/test/images/Image1.jpg")
print(barcode_metrics[0].position)
#print("Position", [(p.x,p.y) for p in barcode_metrics[0].position])
